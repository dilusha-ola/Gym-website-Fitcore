...
export default function MembershipPlanCard({
  ...
  const colorSchemes = {
    diamond: {
      headerBg: "bg-[#392D22] dark:bg-gray-800 transition-colors duration-300",
      titleBg: "bg-[#484747] dark:bg-gray-700 transition-colors duration-300",
      titleText: "text-yellow-400 dark:text-amber-500",
      bodyBg: "bg-[#484747] dark:bg-gray-700 transition-colors duration-300",
      bodyText: "text-white dark:text-gray-100",
      buttonBg: "bg-[#392D22] hover:bg-[#4A3A2E] dark:bg-amber-600 dark:hover:bg-amber-700 transition-colors duration-300",
      buttonText: "text-yellow-400 dark:text-white",
    },
    platinum: {
      headerBg: "bg-black dark:bg-gray-900 transition-colors duration-300",
      ...
      bodyText: "text-white dark:text-gray-100",
      buttonBg: "bg-black hover:bg-gray-900 dark:bg-amber-600 dark:hover:bg-amber-700 transition-colors duration-300",
      buttonText: "text-yellow-400 dark:text-white",
    },
    gold: {
      headerBg: "bg-yellow-400 dark:bg-amber-700 transition-colors duration-300",
      titleBg: "bg-black dark:bg-gray-900 transition-colors duration-300",
      titleText: "text-yellow-400 dark:text-amber-500",
      bodyBg: "bg-black dark:bg-gray-900 transition-colors duration-300",
      bodyText: "text-white dark:text-gray-100",
      buttonBg: "bg-yellow-400 hover:bg-yellow-300 dark:bg-amber-600 dark:hover:bg-amber-700 transition-colors duration-300",
      buttonText: "text-black dark:text-white",
    },
    silver: {
      headerBg: "bg-[#484747] dark:bg-gray-800 transition-colors duration-300",
      titleBg: "bg-black dark:bg-gray-900 transition-colors duration-300",
      titleText: "text-yellow-400 dark:text-amber-500",
      bodyBg: "bg-black dark:bg-gray-900 transition-colors duration-300",
      bodyText: "text-white dark:text-gray-100",
      buttonBg: "bg-[#484747] hover:bg-[#555555] dark:bg-amber-600 dark:hover:bg-amber-700 transition-colors duration-300",
      buttonText: "text-yellow-400 dark:text-white",
    },
  };
