        ...
        <div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-2 sm:gap-3 text-sm sm:text-base lg:text-lg">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-amber-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-start gap-2 sm:gap-3 text-sm sm:text-base lg:text-lg">
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-amber-400 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
